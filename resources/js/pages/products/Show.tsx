...
import { ArrowLeft, DollarSign, List, Plus } from 'lucide-react';
            ...
            <div className="p-6">
                ...
                <div className="mb-8 rounded-xl bg-white p-6 shadow-lg dark:bg-gray-800">
                    <div className="flex items-center justify-between">
                        ...
                        <Link
                            ...
                            className="inline-flex items-center rounded-lg bg-yellow-500 px-4 py-2 text-sm font-medium text-white shadow-md transition duration-150 ease-in-out hover:bg-yellow-600 focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 focus:outline-none"
                        >
                            <Plus size={16} className="mr-1 rotate-45" /> Editar
                            Producto
                        </Link>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div className="rounded-lg border border-gray-200 p-4 dark:border-gray-700">
                            <p className="flex items-center text-sm font-medium text-gray-500 dark:text-gray-400">
                                <List size={18} className="mr-2 text-sky-500" />{' '}
                                Stock Actual
                            </p>
                ...
                <div className="mb-8">
                    <h2 className="mb-4 flex items-center text-2xl font-semibold text-gray-800 dark:text-gray-200">
                        <List size={20} className="mr-2" /> Historial de
                        Movimientos de Stock
                    </h2>
                                        ...
                                        .map((movement) => (
                                            ...
                                            >
                                                ...
                                                <td className="px-6 py-4 text-sm whitespace-nowrap">
                                                    <span className="inline-flex rounded-full bg-green-100 px-2 text-xs leading-5 font-semibold text-green-800 dark:bg-green-800 dark:text-green-100">
                                                        {getTypeMovementLabel(
                                                            movement.type,
                                                        )}
                                                    </span>
                                                </td>
                ...
                <div>
                    <h2 className="mb-4 flex items-center text-2xl font-semibold text-gray-800 dark:text-gray-200">
                        <DollarSign size={20} className="mr-2" /> Historial de
                        Costos por Día
                    </h2>
                    <div className="overflow-x-auto rounded-lg border shadow-sm">
                        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
                ...
                <div className="mt-8">
                    ...
                    >
                        <ArrowLeft size={16} className="mr-2" /> Volver al
                        Listado
                    </Link>
                </div>
            </div>
